# Xray server in a tiny [Docker image](https://hub.docker.com/r/adkix/xray-server) based on Alpine Linux.

### It uses [Xray-core](https://github.com/XTLS/Xray-core).

Supported protocols:
- VLESS Reality via TCP (xtls-rprx-vision) or XHTTP
...
/container/envs add key=NETWORK value="<network type tcp/xhttp [optional, default "tcp"]>" list=xray-server
...
NETWORK=<network type tcp/xhttp [optional, default "tcp"]>
